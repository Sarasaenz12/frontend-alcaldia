document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      const response = await fetch("https://backend-alcaldia-5.onrender.com/api/archivos/carga-masiva/", {
        method: "POST",
  ...
  async function cargarColumnas() {
    try {
      let url = "https://backend-alcaldia-5.onrender.com/api/archivos/columnas-disponibles/";
      if (archivoId) {
  ...
  async function mostrarGraficos() {
    ...
    try {
      const res = await fetch("https://backend-alcaldia-5.onrender.com/api/archivos/generar-grafico/", {
        method: "POST",
        headers: {
